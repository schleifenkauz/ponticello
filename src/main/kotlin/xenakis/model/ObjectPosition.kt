...
class ObjectPosition(private var _start: Double = 0.0, private var _y: Double = 0.0) : Comparable<ObjectPosition> {
    ...
    private fun update() {
        viewManager.notifyViews { moved(start, y) }
    }
    ...
    fun copy(): ObjectPosition = ObjectPosition(start, y)
}